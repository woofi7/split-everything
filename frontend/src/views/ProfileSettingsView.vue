...
async function toggleNotifications(): Promise<void> {
  ...
  try {
    if (notifications.value === 'on') {
      ...
      if (outcome !== 'on') notify(whyNotNotifications(outcome), 'error')
    }
  } catch (caught) {
    report(caught, t('Could not change notifications.'))
  } finally {
...
async function save(): Promise<void> {
  ...
  try {
    ...
    report(caught, t('Could not save your profile.'))
  } finally {
...
async function exportData(): Promise<void> {
  ...
  try {
    ...
    report(caught, t('Could not export your data.'))
  }
}
...
async function deleteAccount(): Promise<void> {
  ...
  try {
    ...
    report(caught, t('Could not delete your account.'))
  }
}
</script>
